...
def create_image_with_lines(
    lines, page_number, total_pages, margin_x, margin_y, line_height, output_folder="output", font=None
):
    """
    ...
    # Save the image
    img.save(os.path.join(output_folder, f"post_{page_number}.png"))


def generate_carousel(text, output_folder="output"):
    """
